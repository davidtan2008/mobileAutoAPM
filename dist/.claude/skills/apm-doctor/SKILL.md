...
```bash
python3 ".claude/skills/_apm/scripts/apm_doctor.py" --platform ios
python3 ".claude/skills/_apm/scripts/apm_doctor.py" --platform rn
python3 ".claude/skills/_apm/scripts/apm_doctor.py" --platform android
python3 ".claude/skills/_apm/scripts/apm_doctor.py" --platform harmony
```
